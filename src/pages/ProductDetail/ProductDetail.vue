<template>
	<div :class="$style.page">
			...
			<div :class="$style.productContainer">
					...
					<div :class="$style.imageGallery">
						<div :class="$style.mainImageContainer">
							<button
								:class="[
									$style.favoriteBtn,
									isFavorite ? $style.favoriteBtnActive : '',
								]"
							...
							>
								<img
									:src="
										isFavorite ? darkHeartIcon : heartIcon
									"
									alt="Heart icon"
									:class="[
										$style.heartIcon,
										isFavorite
											? $style.heartIconActive
											: '',
									]"
								/>
							</button>
							...
							>
								...
								<div :class="$style.leatherText">
									<span>{{
										t('product.naturalLeather').split(
											' ',
										)[0]
									}}</span>
									<span>{{
				...
				<div :class="$style.productInfo">
					<div :class="$style.topRow">
						<span v-if="product.discount" :class="$style.badge">{{
							t('product.sale')
						}}</span>
					</div>
					...
					<div :class="$style.titleRow">
						...
						<button
							:class="[
								$style.shareBtn,
								{ [$style.shareBtnClicked]: shareBtnClicked },
							]"
							:aria-label="t('common.share')"
							@click="copyCurrentUrl"
						>
							<img
								src="@assets/ghost_share.svg"
								:alt="t('common.share')"
					...
					<div :class="$style.priceBlock">
						<div
							v-if="!product.price && isLoading"
							:class="$style.skeletonPrice"
						></div>
						<template v-else>
					...
					<div :class="$style.articleRow">
						<span :class="$style.articleLabel">{{
							t('product.article')
						}}</span>
						<span :class="$style.articleValue">{{
							product.article
						}}</span>
					</div>
					...
					<div :class="$style.quantityBlock">
						...
						>
							<img
								...
								:alt="t('product.decreaseQuantity')"
						...
						>
							<img
								...
								:alt="t('product.increaseQuantity')"
								:class="$style.quantityIcon"
							/>
						</button>
					</div>
					...
					<section :class="$style.characteristicsSection">
						<h2 :class="$style.sectionTitle">
							{{ t('product.characteristicsTitle') }}
						</h2>
						...
						<div
							...
							:class="$style.characteristicsTable"
						>
							<div
								v-for="(char, index) in characteristics"
								:key="index"
								:class="$style.characteristicRow"
							>
								<span :class="$style.charLabel">{{
									char.label
								}}</span>
								<span :class="$style.charValue">{{
									char.value
								}}</span>
							</div>
						</div>
		...
		<StatusLine
			:show="showDiscountStatusLine"
			:message="t('product.discountRequestSent')"
		/>
	</div>
</template>
...
<style module>
	...
	.skeletonRow:nth-child(4) {
		width: 85%;
	}
	.skeletonRow:nth-child(5) {
		width: 92%;
	}
