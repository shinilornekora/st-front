				...
				<div :class="$style.tabsWrapper">
					<div :class="$style.tabs">
						<button
							:class="[
								$style.tab,
								{ [$style.tabActive]: activeTab === 'sellers' },
							]"
						...
						<template v-else-if="dashboard">
							...
							<div :class="$style.statsGrid">
								...
								<div :class="$style.statCard">
									...
									<div :class="$style.statSubtext">
										{{ dashboard.revenue.itemsCount }}
										{{ t('admin.items') }}
									</div>
								...
								<div :class="$style.statCard">
									...
									<div
										...
										style="color: #5fdbd1"
									>
										{{ dashboard.growth.percentage }}
									</div>
									<div :class="$style.statSubtext">
										{{ dashboard.growth.itemsCount }}
										{{ t('admin.items') }}
									</div>
		...
		try {
			...
			if (response.success && response.data) {
				...
				applicationsError.value =
					response.error || t('errors.loadApplicationsFailed');
			}
		} catch (err) {
